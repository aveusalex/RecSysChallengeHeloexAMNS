...
def get_bert_embedding(text_list):
    # if text_list is over than 12 items, split it in groups of 12
    if len(text_list) > 12:
        print("Text list is over than 12 items, split it in groups of 12")
        text_list = [text_list[i:i + 12] for i in range(0, len(text_list), 12)]
    embs = []
